# VPC
resource "aws_vpc" "home_task_vpc" {
...
resource "aws_subnet" "public" {
  ...
  vpc_id            = aws_vpc.home_task_vpc.id
...
# Internet Gateway
resource "aws_internet_gateway" "home_task_igw" {
  vpc_id = aws_vpc.home_task_vpc.id
  ...
  depends_on = [aws_vpc.home_task_vpc]
}
...
resource "aws_route_table" "main" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.home_task_igw.id
  }
...
resource "aws_route" "main" {
  route_table_id         = aws_vpc.home_task_vpc.default_route_table_id
